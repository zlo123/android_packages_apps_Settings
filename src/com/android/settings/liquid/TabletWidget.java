...
public class TabletWidget extends SettingsPreferenceFragment
        implements Preference.OnPreferenceChangeListener {

    private static final String TAG = "TabletWidget";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getPreferenceManager() != null) {
                addPreferencesFromResource(R.xml.tablet_widget_settings);
