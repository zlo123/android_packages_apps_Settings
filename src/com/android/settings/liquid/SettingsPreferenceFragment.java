...
public class SettingsPreferenceFragment extends PreferenceFragment 
    ...
    public void onCreate(Bundle savedInstanceState) {
        //TODO Frameworks support required
        mTablet = false;// Settings.System.getInt(getContentResolver(), Settings.System.IS_TABLET, 0) == 1;
        hasTorch = true;// getResources().getBoolean(R.bool.has_torch);
        hasHardwareButtons = false;// getResources().getBoolean(R.bool.has_hardware_buttons);
        hasFastCharge = true;// getResources().getBoolean(R.bool.has_fast_charge);
        hasColorTuning = true;// getResources().getBoolean(R.bool.has_color_tuning);
