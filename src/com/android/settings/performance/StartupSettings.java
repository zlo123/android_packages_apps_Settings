...
public class StartupSettings extends SettingsPreferenceFragment implements
        OnSharedPreferenceChangeListener, OnPreferenceChangeListener{

    File cfg;

    private static final String TAG = "StartupSettings";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.startup_settings);
